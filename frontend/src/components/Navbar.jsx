          ...
          <div className="flex items-center gap5 ">
            {authUser && (
              <>
                ...
                <Link to={"/trip"} className={`btn btn-sm gap-2`}>
                  <User className="size-5" />
                  <span className="hidden sm:inline"> <table>Trip</table></span>
                </Link>

                <Link to={"/expense"} className={`btn btn-sm gap-2`}>
                  <User className="size-5" />
                  <span className="hidden sm:inline">Expense</span>
                </Link>

                <Link to={"/homepage"} className={`btn btn-sm gap-2`}>
                  <User className="size-5" />
